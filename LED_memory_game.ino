...
void setup()
{
  ...
  if (checkButton() == CHOICE_GREEN)
  {
    ...
    setLEDs(CHOICE_RED | CHOICE_BLUE | CHOICE_YELLOW | CHOICE_WHITE); // Turn on the other LEDs until you release button
...
void add_to_moves(void)
{
  ...
  else if (newButton == 4) newButton = CHOICE_WHITE;
...
void toner(byte which, int buzz_length_ms)
{
  ...
  {
    case CHOICE_RED:
      buzz_sound(buzz_length_ms, 956);
      break;
    case CHOICE_GREEN:
      buzz_sound(buzz_length_ms, 758);
      break;
    case CHOICE_BLUE:
      buzz_sound(buzz_length_ms, 638);
      break;
    case CHOICE_YELLOW:
      buzz_sound(buzz_length_ms, 536);
      break;
    case CHOICE_WHITE:
...
{
  setLEDs(CHOICE_GREEN | CHOICE_BLUE | CHOICE_WHITE);
  winner_sound();
  setLEDs(CHOICE_RED | CHOICE_YELLOW);
  winner_sound();
  setLEDs(CHOICE_GREEN | CHOICE_BLUE);
  winner_sound();
  setLEDs(CHOICE_RED | CHOICE_YELLOW | CHOICE_WHITE);
  winner_sound();
}
...
{
  setLEDs(CHOICE_RED | CHOICE_GREEN | CHOICE_WHITE);
  buzz_sound(255, 1500);
  ...
  setLEDs(CHOICE_BLUE | CHOICE_YELLOW | CHOICE_WHITE);
  buzz_sound(255, 1500);
}
...
int melody1[] = {
  NOTE_C3,  0,        0,        0,        NOTE_C5,  0,        NOTE_DS5, 0, 
  NOTE_F5,  0,        NOTE_FS5, 0,        NOTE_F5,  0,        NOTE_DS5, 0, 
  NOTE_C5,  0,        0,        0,        0,        0,        NOTE_A4,  NOTE_D5, 
  NOTE_C5,  0,        0,        0,        0,        0,        NOTE_G3,  0,       
  NOTE_C3,  0,        0,        0,        NOTE_C5,  0,        NOTE_DS5, 0,        
  NOTE_F5,  0,        NOTE_FS5, 0,        NOTE_F5,  0,        NOTE_DS5, 0,       
  NOTE_FS5, 0,        0,        0,        0,        0,        0,        0,       
  NOTE_FS5, NOTE_F5,  0,        NOTE_DS5, NOTE_FS5, NOTE_F5,  0,        NOTE_DS5 
};
...
void play_beegees()
{
  ...
  while (checkButton() == CHOICE_NONE) //Play song until you press a button
  {
    ...
    for (int thisNote = 0; thisNote < 64; thisNote++) {
      changeLED();
      tone(BUZZER2, melody1[thisNote], noteDuration);
...
int pulse_fn(int frequency) {
  int pulse = (1 / frequency) / 2 * 1000000;
  return pulse;
}
